...
import ThemeHover from 'apps/host/src/components/theme/ThemeHover';
...
const ThemeEditor = () => {
  ...
  const resultOrder =
    data?.theme_order &&
    data?.theme_order?.length > 0 &&
    data?.theme_order.toString().split(',');
        ...
        >
          ...
          <Box>
            ...
            <Box
              ...
              border="1px solid #127CA6"
              backgroundColor={
                activeSidebar.navbar.navbar1 === true ? '#127CA6' : '#fff'
              }
              _hover={{
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.navbar.navbar2 === true ? '#127CA6' : '#fff'
              }
              _hover={{
                backgroundColor: '#127CA6',
                color: 'white',
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.navbar.navbar3 === true ? '#127CA6' : '#fff'
              }
              _hover={{
                backgroundColor: '#127CA6',
                color: 'white',
          ...
          <Box>
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.hero.hero1 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
                setHeroEditor('hero1');
                setActiveSidebar({
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.hero.hero2 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
                setHeroEditor('hero2');
                setActiveSidebar({
          ...
          <Box>
            ...
            <Box
              ...
              color={
                activeSidebar.feature.feature1 === true ? '#fff' : '#127CA6'
              }
              backgroundColor={
                activeSidebar.feature.feature1 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
          ...
          <Box>
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.menu.menu1 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
                setMenuEditor('menu1');
                setActiveSidebar({
          ...
          <Box>
            ...
            <Box
              ...
              color={
                activeSidebar.testimoni.testimoni1 === true ? '#fff' : '#127CA6'
              }
              backgroundColor={
          ...
          <Box>
            ...
            <Box
              ...
              color={
                activeSidebar.gallery.gallery1 === true ? '#fff' : '#127CA6'
              }
              backgroundColor={
                activeSidebar.gallery.gallery1 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
          ...
          <Box>
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.footer.footer1 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.footer.footer2 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
            ...
            <Box
              ...
              backgroundColor={
                activeSidebar.footer.footer3 === true ? '#127CA6' : '#fff'
              }
              onClick={() => {
