describe("Registration and website creation", () => {
    it("User successfully registers and creates a new website", () => {
        ...
        cy.get('input[name=email]').type("aga@gmail.com")
        ...
        cy.get('input[name=title]').type("Aga UMKM");
        cy.get('textarea[name=description]').type("Aga Website adalah website umkm kelas menengah di area Malang Raya");
        cy.get('input[name=address]').type("Malang, Jawa Timur");
        cy.get('input[name=meta]').type("Aga");
